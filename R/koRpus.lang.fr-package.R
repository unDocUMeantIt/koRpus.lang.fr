#' Language Support for 'koRpus' Package: French.
#'
#' \tabular{ll}{
#' Package: \tab koRpus.lang.fr\cr
#' Type: \tab Package\cr
#' Version: \tab 0.1-1\cr
...
#'
#' @aliases koRpus.lang.fr-package
#' @name koRpus.lang.fr-package
#' @docType package
#' @title The koRpus.lang.fr Package
#' @author Meik Michalke, with contributions from Alexandre Brulet
#' @keywords package
NULL
